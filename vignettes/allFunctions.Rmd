---
title: "Investigate mating scenes with mateable"
...
Mating potentials in space and time are continuous. In contrast, mating compatibility between two individuals, as we have modeled it here, is either possible or not. Therefore mating potential for pairs is either 1 or 0. This approach is appropriate for many plant mating systems where there are several mating types. *Animals?*
